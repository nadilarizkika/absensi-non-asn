...
<style>
    ...
    video {
        ...
        border: 1px solid #ccc;
        margin-bottom: 10px;
        transform: scaleX(-1); /* Mirror agar user lebih nyaman */
    }
...
<div class="attendance-container">
    ...
    <form method="POST" action="{{ route('form.masuk.store') }}">
        ...
        <div class="form-group mb-3">
            <label for="jam_datang">Jam Masuk</label>
            <input type="time" class="form-control" name="jam_datang" value="{{ date('H:i') }}" readonly>
        </div>
